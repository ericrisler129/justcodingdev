...
<script type='text/javascript'>
<?php $adUrl = '/309602/g.site150.tmus'; if(substr($_SERVER['REQUEST_URI'],1,4) == 'jobs') $adUrl .= '/zone_jobs'; ?>
  googletag.cmd.push(function() {
    googletag.defineSlot('<?php echo $adUrl; ?>', [728, 90], 'div-gpt-top-leaderboard').addService(googletag.pubads());
    googletag.defineSlot('<?php echo $adUrl; ?>', [728, 90], 'div-gpt-bottom-leaderboard').addService(googletag.pubads());
    googletag.defineSlot('<?php echo $adUrl; ?>', [300, 250], 'div-gpt-sidebar-1').addService(googletag.pubads());
