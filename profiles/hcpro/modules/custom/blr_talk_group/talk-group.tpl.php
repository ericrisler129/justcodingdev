...
<h2 style="color:#0A8282">You are not currently subscribed to the <?php print $title; ?></h2>

<div style="float: left; padding-right: 20px; padding-bottom: 10px; width: 200px;">
  <img src="/<?php print path_to_theme(); ?>/logo.jpg" />

<div class="button wide" style="margin-top: 5px;width:100%;text-align:center;"><a href="http://list.hcpro.com/read/?forum=<?php print $list; ?>" class="button-blue" target="_blank">Visit the Archives</a></div>
<div class="button wide" style="margin-top: 10px;width:100%;text-align:center;"><a href="/talk-group/subscribe" class="button-green">Subscribe</a></div>
